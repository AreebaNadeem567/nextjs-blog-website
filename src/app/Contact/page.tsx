...
import { FaYoutube, FaTwitter, FaFacebookF } from "react-icons/fa";  // Ensure this import is correct
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-gray-50 p-10 md:p-20">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-green-500 text-white px-6 py-3 rounded hover:bg-green-600 transition mt-20"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 md:pl-16 space-y-6 text-gray-800">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a
                href="#"
                className="w-12 h-12 flex items-center justify-center rounded-full bg-green-500 hover:bg-green-600 transition"
              >
